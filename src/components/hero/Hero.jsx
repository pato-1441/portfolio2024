  ...
  return (
    <main className="flex-1 py-8 sm:py-16">
      <section className="flex flex-col gap-2">
        ...
        <p className="text-lg text-justify sm:text-2xl sm:w-1/3 sm:leading-tight">
        ...
        <div className="mt-2">
          <a
            ...
            className="flex w-fit items-center gap-2 transition-all duration-150 sm:text-base font-medium px-4 py-2 rounded-full border border-gray-200 hover:shadow-white hover:shadow-button"
          >
